...
function Radar(_a) {
    ...
    return (jsxRuntime.jsxs("div", { className: "radar", children: [jsxRuntime.jsx(Blips, { selected: selected, setSelected: setSelected, entries: blips }), jsxRuntime.jsx(SVGGrid, {})] }));
}
