...
function Categories(_a) {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: Object.entries(categoryEntries).map(function (_a) {
            var category = _a[0], entries = _a[1];
            return (jsxRuntime.jsxs("div", { className: "category ".concat(getCategoryId(category)), children: [jsxRuntime.jsx("h3", { children: category }), jsxRuntime.jsx("ul", { children: entries.map(function (entry) {
                            return (jsxRuntime.jsx("li", { onMouseOver: function () { return setSelected(entry.originId); }, className: selected === entry.originId ? "selected" : "", children: entry.label }, entry.id));
                        }) })] }, category));
        }) }));
}
...
function Icon(_a) {
    ...
    switch (type) {
        ...
        case "emoji":
            return jsxRuntime.jsx("div", { className: "icon emoji ".concat(tooltip && "in"), children: str });
        case "data":
        case "url":
            return (jsxRuntime.jsx("div", { className: "icon image ".concat(tooltip && "in"), children: jsxRuntime.jsx("div", { style: {
...
function Tooltip(_a) {
    var blip = _a.blip;
    return (jsxRuntime.jsxs("div", { className: "tooltip", children: [jsxRuntime.jsxs("div", { className: "tooltip-title", children: [jsxRuntime.jsx(Icon, { tooltip: true, blip: blip }), jsxRuntime.jsx("b", { children: blip.label })] }), jsxRuntime.jsx("div", { className: "tooltip-statusWrapper", children: jsxRuntime.jsx("span", { className: "tooltip-status", children: blip.status }) }), jsxRuntime.jsx("div", { className: "tooltip-category", children: blip.category })] }));
}

function Blips(_a) {
    var selected = _a.selected, setSelected = _a.setSelected, entries = _a.entries;
    var animatedBlips = useAnimatedBlips(entries);
    return (jsxRuntime.jsx("div", { className: "blips", children: animatedBlips.map(function (blip, i) {
            return (jsxRuntime.jsx("div", { className: "blip ".concat(getStatusId(blip.status), " ").concat(selected === blip.originId ? "selected" : ""), onMouseOver: function () { return setSelected(blip.originId); }, style: { transform: blip.translate() }, children: blip.isSelected(selected) ? (jsxRuntime.jsx(Tooltip, { blip: blip })) : (jsxRuntime.jsx(Icon, { blip: blip })) }, blip.label));
        }) }));
}
function useAnimatedBlips(entries) {
    var _a = react.useState([]), animatedNodes = _a[0], setAnimatedNodes = _a[1];
...
function SVGGrid() {
    ...
    return (jsxRuntime.jsx("svg", { width: width, height: height, style: { backgroundColor: "white" }, children: jsxRuntime.jsxs("g", { style: { backgroundColor: "green" }, transform: "translate(".concat(width / 2, ", ").concat(height / 2, ")"), children: [jsxRuntime.jsx("line", { x1: 0, y1: -380, x2: 0, y2: 380, stroke: "#f2f2ff", strokeWidth: 2 }), jsxRuntime.jsx("line", { x1: -width / 2, y1: 0, x2: width / 2, y2: 0, stroke: "#f2f2ff", strokeWidth: 2 }), status.map(function (status, i) {
                    return (jsxRuntime.jsx("g", { children: jsxRuntime.jsx("circle", { cx: 0, cy: 0, r: rings[i].radius, fill: "none", stroke: "#dde", strokeWidth: 4 }) }, status));
                })] }) }));
}
...
function Radar(_a) {
    ...
    var blips = entries.map(function (entry) { return new Blip(entry); });
    return (jsxRuntime.jsxs("div", { className: "radar", children: [jsxRuntime.jsx(Categories, { selected: selected, setSelected: setSelected }), jsxRuntime.jsx(Blips, { selected: selected, setSelected: setSelected, entries: blips }), jsxRuntime.jsx(SVGGrid, {})] }));
}
